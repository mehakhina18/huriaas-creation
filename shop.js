...
const products = [
 ...
 { id: "p43", name: "Birthday Bliss Basket", price: 6000, desc: "Thoughtfully curated to make every birthday extra special.", img: "product43.jpg", category: ["Women","Men"] }, 
 { id: "p44", name: "Eternal Promise Gift Set", price:2000, desc: "A timeless keepsake to celebrate love and new beginnings.", img: "product44.jpg",  category: ["Women","Men"] },
 { id: "p45", name: "Royal Money Bouquet", price:7500, desc: "An elegant way to gift love, blessings, and cash.", img: "product45.jpg", category: ["Baby Boy","Baby Girl"] }, 
 { id: "p46", name: "Royal Blue Bloom", price:8000, desc: "Luxury wrapping with cash, chocolates, and thoughtful details.", img: "product46.jpg", category: ["Baby Boy"] },       
 { id: "p47", name: "Majestic Bloom", price:8000, desc: "Handcrafted to make every celebration unforgettable.", img: "product47.jpg", category: ["Baby Girl"] }, 
  { id: "p48", name: "Frozen Fantasy Basket", price:7000, desc: "Packed with fun, smiles, and birthday surprises for little ones.", img: "product48.jpg", category: ["Baby Girl"] }, 
  { id: "p49", name: "Little Princess Express", price:15000, desc: "A handcrafted gift train filled with love, surprises, and endless smiles.", img: "product49.jpg", category: ["Baby Girl"] }, 
];
